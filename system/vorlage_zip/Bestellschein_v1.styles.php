...
<office:document-styles xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:officeooo="http://openoffice.org/2009/office" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:drawooo="http://openoffice.org/2010/draw" xmlns:calcext="urn:org:documentfoundation:names:experimental:calc:xmlns:calcext:1.0" xmlns:loext="urn:org:documentfoundation:names:experimental:office:xmlns:loext:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2">
    ...
    <office:styles>
        <style:default-style style:family="graphic">
            ...
            <style:text-properties style:use-window-font-color="true" style:font-name="Liberation Serif" fo:font-size="12pt" fo:language="de" fo:country="AT" style:letter-kerning="true" style:font-name-asian="DejaVu Sans" style:font-size-asian="10.5pt" style:language-asian="zh" style:country-asian="CN" style:font-name-complex="DejaVu Sans" style:font-size-complex="12pt" style:language-complex="hi" style:country-complex="IN"/>
        </style:default-style>
        ...
        <style:style style:name="WAWITabHeader1" style:family="paragraph" style:parent-style-name="Table_20_Contents">
        ...
        <style:style style:name="WAWIArtTabRechts" style:family="paragraph" style:parent-style-name="Table_20_Contents">
            ...
            <style:text-properties style:font-name="Arial" fo:font-family="Arial" style:font-family-generic="swiss" style:font-pitch="variable" fo:font-size="9pt" officeooo:rsid="005dacbc" style:font-size-asian="9pt" style:font-size-complex="9pt"/>
        </style:style>
    ...
    <office:automatic-styles>
        <style:style style:name="KopfTab" style:family="table" style:master-page-name="">
        ...
        <style:style style:name="KopfTab.A1" style:family="table-cell">
        ...
        <style:style style:name="MP1" style:family="paragraph" style:parent-style-name="Table_20_Contents">
            ...
            <style:paragraph-properties fo:margin-left="0cm" fo:margin-right="0cm" fo:line-height="100%"  style:auto-text-indent="false" style:shadow="none" text:number-lines="false" text:line-number="0"/>
        ...
        <style:style style:name="MT1" style:family="text">
            <style:text-properties fo:font-size="16pt" fo:font-weight="bold" style:font-size-asian="16pt" style:font-weight-asian="bold" style:font-size-complex="16pt" style:font-weight-complex="bold" fo:padding="0.101cm"  style:shadow="none"/>
        </style:style>
        ...
        <style:page-layout style:name="Mpm1">
            <style:page-layout-properties fo:page-width="21.001cm" fo:page-height="29.7cm" style:num-format="1" style:print-orientation="portrait" fo:margin-top="1.499cm" fo:margin-bottom="1.3cm" fo:margin-left="2cm" fo:margin-right="2cm" style:shadow="none" style:writing-mode="lr-tb" draw:fill-image-width="0cm" draw:fill-image-height="0cm" style:footnote-max-height="0cm">
                <style:columns fo:column-count="1" fo:column-gap="0cm"/>
                <style:footnote-sep style:width="0.018cm" style:distance-before-sep="0.101cm" style:distance-after-sep="0.101cm" style:line-style="solid" style:adjustment="left" style:rel-width="25%" style:color="#000000"/>
            </style:page-layout-properties>
            <style:header-style>
                <style:header-footer-properties fo:min-height="0.6cm" fo:margin-left="0cm" fo:margin-right="0cm" fo:margin-bottom="0.499cm" style:dynamic-spacing="false" draw:fill="none"/>
            </style:header-style>
            <style:footer-style/>
        </style:page-layout>
    </office:automatic-styles>
    <office:master-styles>
        <style:master-page style:name="Standard" style:page-layout-name="Mpm1">
            <style:header>
                <table:table table:name="KopfTab" table:style-name="KopfTab">
                    ...
                    <table:table-row>
                        <table:table-cell table:style-name="KopfTab.A1" office:value-type="string">
                            <text:p text:style-name="MP1">
                                <text:span text:style-name="MT1">Bestellschein
                                <text:line-break/><?php echo $input->bestell_nr ?></text:span></text:p>
                        ...
                        <table:table-cell table:style-name="KopfTab.A1" office:value-type="string">
                            ...
                            <text:p text:style-name="MP5"><text:span text:style-name="MT2">Kontakt: </text:span>
                                <text:a xlink:type="simple" xlink:href="mailto:einkauf@technikum-wien.at" text:style-name="Internet_20_link" text:visited-style-name="Visited_20_Internet_20_Link">
                        ...
                        <table:table-cell table:style-name="KopfTab.A1" office:value-type="string">
                            <text:p text:style-name="Table_20_Contents">
                                <draw:frame draw:style-name="Mfr1" draw:name="LogoBild" text:anchor-type="paragraph" svg:width="4.417cm" svg:height="2.355cm" draw:z-index="2">
                                    <draw:image xlink:href="Pictures/100002010000012C000000A070EBD117.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
                                </draw:frame>
                            </text:p>
                        </table:table-cell>
                    </table:table-row>
                ...
                <text:p text:style-name="MP6">
                    <text:s/>
                    <text:span text:style-name="MT3">Wir bitten um Angabe unserer Bestellnummer auf Rechnung und Lieferschein!</text:span>
                </text:p>
            </style:header>
        </style:master-page>
    </office:master-styles>
