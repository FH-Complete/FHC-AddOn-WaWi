                    ...
                    <table:table-row>
                        <table:table-cell table:style-name="KopfTab.A1" office:value-type="string">
                            <text:p text:style-name="MP1">
                                <text:span text:style-name="MT1">Bestellschein</text:span>
                                <text:line-break/>Nr.: <?php echo $input->bestell_nr ?></text:p>
                        ...
                        <table:table-cell table:style-name="KopfTab.A1" office:value-type="string">
                            ...
                            <text:p text:style-name="MP5">
                                <text:span text:style-name="MT2">Leitung: Michaela Ribisch<text:line-break/></text:span>
