...
<head>
	...
	<script type="text/javascript" src="../../../vendor/jquery/jquery2/jquery-2.2.4.min.js"></script>
...
function printPersonBerechtigungenList($rights, $uid)
{
	...
	if(!$benutzer_user->load($uid))
		die('Person nicht gefunden');

	$htmlstr  = "<div id=\"wrapper\">";
	$htmlstr  = "Berechtigungen von ".$benutzer_user->vorname.' '.$benutzer_user->nachname;
